...
const modules = [
  { icon: Image, title: "AI Image Generation", desc: "Master Midjourney v6, DALL-E 3 and Stable Diffusion for photorealistic and artistic visuals.", tools: ["Midjourney", "DALL-E 3", "Stable Diffusion"] },
  { icon: Layers, title: "Brand Identity with AI", desc: "Create complete brand identities — logos, color palettes, typography and brand guidelines.", tools: ["Adobe Firefly", "Canva AI", "Looka"] },
  { icon: Wand2, title: "UI/UX with AI", desc: "Design interfaces 10x faster using Figma AI, Galileo and other AI-native design tools.", tools: ["Figma AI", "Galileo", "Framer AI"] },
  { icon: Palette, title: "AI Video & Motion", desc: "Create professional videos and animations using Runway, Pika and Kling AI.", tools: ["Runway", "Pika", "Kling"] },
];
    ...
    <div className="pt-16 min-h-screen">
      ...
      <section className="py-16 px-4 sm:px-6 max-w-6xl mx-auto pb-20">
        <div className="grid md:grid-cols-2 gap-5 mb-12">
          {modules.map((m) => (
            <div key={m.title} className="rounded-2xl bg-surface-1 border border-brand-purple/20 p-6 hover:border-brand-purple/40 transition-all">
              <div className="p-2.5 rounded-xl bg-brand-purple/10 w-fit mb-4"><m.icon className="h-5 w-5 text-brand-purple" /></div>
