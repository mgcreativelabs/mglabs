...
const tools = [
  { name: "ChatGPT", category: "Text Generation", pricing: "freemium", description: "OpenAI's flagship model." },
  { name: "Claude", category: "Text Generation", pricing: "freemium", description: "Anthropic's model." },
  { name: "Gemini", category: "Text Generation", pricing: "freemium", description: "Google's multimodal AI." },
  { name: "Midjourney", category: "Image Generation", pricing: "paid", description: "The gold standard for AI art." },
  { name: "Cursor", category: "Code Generation", pricing: "freemium", description: "AI-native code editor." },
  { name: "Runway", category: "Video Generation", pricing: "freemium", description: "Professional AI video generation." },
];
    ...
    <div className="pt-16 min-h-screen">
      ...
      <section className="py-20 px-4 sm:px-6 max-w-5xl mx-auto text-center">
        ...
        <h1 className="text-5xl sm:text-6xl font-bold text-white mb-5 leading-tight">
          AI Learning <span className="bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">Hub</span>
        </h1>
      ...
      <section className="py-16 px-4 sm:px-6 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          {courses.map((course) => (
            <Card key={course.id} className="border border-white/10 bg-white/5 p-6 rounded-2xl">
      ...
      <section className="py-16 px-4 sm:px-6 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {tools.map((tool) => (
            <div key={tool.name} className="rounded-2xl p-5 border border-white/10 bg-white/5">
