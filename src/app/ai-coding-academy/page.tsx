...
const tracks = [
  { title: "AI-Assisted Development", desc: "Use Cursor, Copilot and Codeium to code 3–10x faster.", tools: ["Cursor", "GitHub Copilot", "Codeium"], level: "Beginner", icon: Code },
  { title: "Build Full-Stack Apps with AI", desc: "Go from idea to deployed app using v0, Bolt, and Next.js.", tools: ["v0", "Bolt", "Next.js", "Vercel"], level: "Intermediate", icon: Terminal },
  { title: "LLM API Integration", desc: "Build AI-powered features using OpenAI, Anthropic and Groq APIs.", tools: ["OpenAI API", "Anthropic API", "Vercel AI SDK"], level: "Intermediate", icon: Cpu },
  { title: "Advanced AI Engineering", desc: "RAG systems, vector databases, fine-tuning, production AI.", tools: ["Pinecone", "Supabase", "LlamaIndex"], level: "Advanced", icon: GitBranch },
];
    ...
    <div className="pt-16 min-h-screen">
      ...
      <section className="py-16 px-4 sm:px-6 max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-5 mb-16">
          {tracks.map((t) => (
            <div key={t.title} className="rounded-2xl bg-surface-1 border border-white/[0.06] p-6 hover:border-brand-blue/30 transition-all">
              <div className="flex items-start justify-between mb-4">
                <div className="p-2.5 rounded-xl bg-surface-3"><t.icon className="h-5 w-5 text-brand-blue" /></div>
                <span className="text-xs px-2 py-1 rounded-full bg-surface-3 text-gray-400 border border-white/10">{t.level}</span>
              </div>
              <h3 className="font-semibold text-white text-lg mb-2">{t.title}</h3>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-500 mb-8">Every track ends with a deployable project for your portfolio. No toy examples — real apps that solve real problems.</p>
