  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <section className="px-4 sm:px-6 max-w-6xl mx-auto pb-24">
          ...
          {products.map((product) => (
            <div
              ...
              className={`relative rounded-2xl border flex flex-col transition-all duration-200 ${
                product.featured
                  ? "bg-gradient-to-b from-brand-blue/10 to-surface-1 border-brand-blue/40 shadow-xl shadow-brand-blue/10"
                ...
                <div className="mb-5">
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      ...
                      <p className={`text-sm font-medium ${product.featured ? "text-brand-blue" : "text-gray-400"}`}>
                        {product.tagline}
                      </p>
                    </div>
        ...
        <div className="mt-12 rounded-2xl bg-white/[0.02] border border-white/[0.07] p-10 text-center">
          <div className="inline-flex items-center gap-2 mb-4">
            <Star className="w-5 h-5 text-yellow-400" />
            <span className="text-white font-bold">Want more than a product?</span>
            <Star className="w-5 h-5 text-yellow-400" />
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              href="/start"
              className="px-6 py-3 rounded-xl font-medium text-sm text-gray-300 border border-white/10 hover:border-white/20 hover:text-white transition-all text-center flex items-center gap-2 justify-center"
            >
