export default function Home() {
  return (
    <main className="min-h-screen bg-slate-950 relative overflow-hidden w-full">
      {/* Background */}
      ...
      {/* HERO - CENTERED FOR ALL SCREENS */}
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center w-full px-6 pt-20">
        ...
        <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold text-center mb-6 tracking-tight w-full">
        ...
        <p className="text-gray-300 text-xl md:text-2xl text-center max-w-3xl mx-auto mb-12 leading-relaxed w-full px-4">
        ...
        <div className="flex items-center justify-center gap-16 text-sm w-full">
      ...
      {/* FEATURES SECTION - CENTERED FOR ALL SCREENS */}
      <section className="relative z-10 py-40 px-6 w-full">
        <div className="w-full max-w-7xl mx-auto">
          ...
          {/* Cards Grid - CENTERED */}
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-32 place-items-center">
            {/* Card 1 */}
            <div className="group p-8 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-500 hover:-translate-y-2 w-full max-w-md">
