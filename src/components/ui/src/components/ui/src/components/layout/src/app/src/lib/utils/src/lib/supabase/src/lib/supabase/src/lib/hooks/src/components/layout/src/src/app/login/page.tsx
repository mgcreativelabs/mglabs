    ...
    <div className="min-h-screen flex items-center justify-center px-4 mesh-bg">
      <div className="w-full max-w-md">
        ...
        <div className="glass rounded-3xl p-8 border border-white/[0.06]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading}
              className="w-full h-12 rounded-xl bg-gradient-brand text-white font-semibold text-sm shadow-lg shadow-brand-blue/20 hover:shadow-brand-blue/40 hover:scale-[1.02] disabled:opacity-50 transition-all">
        ...
        <p className="text-center text-sm text-gray-600 mt-5">
          ...
          <Link href="/signup" className="text-brand-blue hover:underline font-medium">Create one free</Link>
        </p>
      </div>
    </div>
  );
