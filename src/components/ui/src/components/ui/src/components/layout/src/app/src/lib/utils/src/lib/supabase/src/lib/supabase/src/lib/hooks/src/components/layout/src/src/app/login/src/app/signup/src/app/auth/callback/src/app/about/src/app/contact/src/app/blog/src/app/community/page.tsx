  ...
  return (
    <div className="pt-16 min-h-screen">
      <section className="py-20 px-4 sm:px-6 max-w-5xl mx-auto text-center mesh-bg">
        ...
        <p className="text-gray-400 text-xl max-w-2xl mx-auto mb-8">Share what you&apos;re building, ask questions, find collaborators, and grow with the best AI creator community online.</p>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-20 space-y-3">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/signup" className="px-4 py-2 rounded-xl bg-gradient-brand text-white text-sm font-semibold hover:scale-[1.02] transition-all">New post</Link>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 flex-wrap mb-1">
                  ...
                  <span className={`text-xs px-2 py-0.5 rounded-full border font-medium ${categoryColors[post.category]}`}>{post.category}</span>
                </div>
